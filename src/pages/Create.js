...
export default function Create() {
  ...
  const getBallotType1 = (current, ballotType1) => {
    if (ballotType1) {
  ...
  const getBallotType2 = (current, ballotType2) => {
    if (ballotType2) {
  ...
  const backgroundButtons = backgrounds.map((backgroundImage, index) => (
    <Avatar
      variant="rounded"
    ...
    <>
      ...
      >
        ...
        >
              ...
              <FormGroup>
                <FormControlLabel
                  control={
                    <Switch
                      checked={
                        ballot.ballotType === 0 || ballot.ballotType === 2
                      }
                      onChange={(e) => {
                        setBallot({
                          ...ballot,
                          ballotType: getBallotType1(
                            ballot.ballotType,
                            e.target.checked
                          ),
                        });
                ...
                <FormControlLabel
                  control={
                    <Switch
                      checked={
                        ballot.ballotType === 1 || ballot.ballotType === 2
                      }
                      onChange={(e) => {
                        setBallot({
                          ...ballot,
                          ballotType: getBallotType2(
                            ballot.ballotType,
                            e.target.checked
                          ),
                        });
          ...
          {currentStep === "muhur" && ballot.ballotType !== 1 && (
            <FormControl
              sx={{
                mr: "16px",
              }}
          ...
          {currentStep === "muhur" && ballot.ballotType !== 0 && (
            <FormControl
              sx={{
                mr: "16px",
              }}
